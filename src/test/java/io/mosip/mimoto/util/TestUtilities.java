...
public class TestUtilities {
    ...
    public static VPResponseDTO getVerifiablePresentationResponseDTO(String clientId, String clientName, String clientLogo, boolean isTrusted, boolean isPreRegisteredWithWallet, String redirectUri, OpenID4VP openID4VP, Instant time) {
        ...
        VerifiablePresentationSessionData presentationSessionData = new VerifiablePresentationSessionData("123e4567-e89b-12d3-a456-426614174000", "authorizationRequest", null, time, true, null);

        VPResponseDTO presentationResponseDTO = new VPResponseDTO(presentationSessionData.getPresentationId(), null, presentationVerifierDTO);
